...
class MessageBase(BaseModel):
    ...
    sources: Optional[List[Dict[str, Any]]] = Field(
        default=None, description="Retrieved sources for assistant messages"
    )
...
class ConversationCreate(BaseModel):
    ...
    reference: Optional[List[Any]] = Field(
        default_factory=list, description="Reference data"
    )
...
class ConversationResponse(BaseModel):
    ...
    message: List[Dict[str, Any]] = Field(
        default_factory=list, description="Array of message objects"
    )
...
class ConversationContextResponse(BaseModel):
    ...
    messages: List[Dict[str, str]] = Field(
        ..., description="List of {role, content} for LLM"
    )
