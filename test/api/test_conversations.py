...
class TestConversationsAPI(APITestBase):
    ...
    def test_list_conversations(self):
        ...
        response = self.client.get("/conversations/", params={"dialog_id": self.dialog_id})
    ...
    def test_append_message(self):
        ...
        response = self.client.post(f"/conversations/{self.conversation_id}/messages", json=message)
    ...
    def test_update_conversation(self):
        ...
        response = self.client.put(f"/conversations/{self.conversation_id}", json=update_data)
        assert response.status_code == 200
        data = response.json()
