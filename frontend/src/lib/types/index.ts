...
// ── Agents (legacy — kept for backward compat with components not yet migrated) ──
...
// ── Knowledgebases (new — replaces Datasets) ─────────────────────────────────
...
// ── Conversations (new — replaces Chat Sessions) ─────────────────────────────

/** A single message object as stored in ConversationResponse.message array. */
...
// ── Chat Sessions / History (legacy — kept for existing store compatibility) ──
